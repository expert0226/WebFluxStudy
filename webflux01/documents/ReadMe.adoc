...
* 나머지는 취향의 문제...
** image:./images/001.png?raw=true[start.spring.io]
* [Generate Project] 버튼을 클릭해서 zip 로 다운로드 받는다.
* 다운로드 반은 zip 파일을 적당한 위치에서 압축 해제한다.
* 본인이 선호하는 IDE 로 프로젝트를 오픈한다.
** image:./images/002.png?raw=true[build.gradle 를 Open 해 주자]
** image:./images/003.png?raw=true[Open as Project 를 선택해 주자]
** image:./images/004.png?raw=true[몇 가지 설정을 조정해 주자]
** image:./images/005.png?raw=true[Open 완료]
...
** image:./images/006.png?raw=true[IE 라니... 나의 Chrome 는 소중하니까!]
...
* image:./images/007.png?raw=true[Hello Mono!!!]
* image:./images/008.png?raw=true[Hello Flux!!!]
